        ...
        <div className="flex w-full justify-center items-start mt-8 md:mt-24">
            <div className="flex flex-col justify-center items-center gap-24 lg:px-0 sm:px-12 px-8">
                ...
                <div className="flex gap-12">
                        <animated.div style={useSpring({from: { opacity: 0, transform: 'translateY(50px)' },to: { opacity: 1, transform: 'translateY(0)' },delay: 800,config: { duration: 800 },})}  className="flex-row gap-12 items-center hidden md:flex">
                            <Text text="TECH STACK" customStyle="font-bold text-xl text-white mt-1 font-inter" />
                            <Text text="|" customStyle="font-thin text-2xl text-white" />
                        </animated.div>
                    <animated.div style={iconAnimations} className="flex flex-row gap-6 items-center justify-center mt-1" id="tech-stack">
                        {TechData.map((item) => (
